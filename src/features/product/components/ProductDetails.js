          ...
          <div className="details-desc mt-4 lg:row-span-3 lg:mt-0">
            ...
            <div className="mt-6">
              ...
              <div className="flex items-center">
                ...
                <a  className="ml-3 text-sm font-medium text-customGreen hover:text-customSage">
            ...
            <form className="mt-10">
              ...
              <div className="mt-10">
                ...
                <RadioGroup value={selectedSize} onChange={setSelectedSize} className="mt-4">
                  ...
                  <div className="details-font grid grid-cols-4 gap-3 sm:grid-cols-8 lg:grid-cols-4" style={{fontSize:'0.5rem'}}>
                    {sizes.map((size) => (
                      <RadioGroup.Option
                        key={size.name}
                        value={size}
                            ...
                            {size.inStock ? (
                              <span
                                className={classNames(
                                  ...
                                  checked ? 'border-customSage' : 'border-transparent',
