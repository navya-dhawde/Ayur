               ...
               <div className="border-b border-gray-900/10 mt-15 pb-12">
                 ...
                 <div className="mt-10 flex items-center justify-end gap-x-6">
                   <button
                     ...
                     type="submit"
                     className="rounded-md bg-customSage px-2 py-1 text-sm font-semibold text-white shadow-sm hover:bg-customTan focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-customGreen"
                   >
                     Cancel
                   </button>
                   <button
                     type="submit"
                     className="rounded-md bg-customGreen px-2 py-1 text-sm font-semibold text-white shadow-sm hover:bg-customMint focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-customGreen"
                   >
                     Add New Address
                   </button>
                 </div>
                        ...
                        <div className="space-y-12">
                          <div className="border-b border-gray-900/10 mt-15 pb-12">
                            ...
                            <div className="mt-10 flex items-center justify-end gap-x-6">
                              ...
                              <button
                                type="submit"
                                className="rounded-md bg-customGreen px-2 py-1 text-sm font-semibold text-white shadow-sm hover:bg-customGreen focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-customGreen"
                              >
                                Save Address
                              </button>
                            </div>
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center justify-evenly my-2">
                      ...
                      onClick={(e) =>{ handleEditForm(index); setSelectedEditIndex(index); setShowAddressForm(false)}}
                        type="button"
                        className="cursor-pointer items-center justify-center rounded-md border border-transparent bg-customGreen mb-1 px-2 py-1 text-base font-medium text-white shadow-sm hover:bg-customMint"
                      >
                        Edit
                      </button>
                      <button
                        ...
                        type="button"
                        className="cursor-pointer items-center justify-center rounded-md border border-transparent bg-customSage mt-1 px-2 py-1 text-base font-medium text-white shadow-sm hover:bg-customMint"
                      >
                        Remove
                      </button>
                    </div>
